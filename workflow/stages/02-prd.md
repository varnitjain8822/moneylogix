...
|------|--------|--------|----------|
| User Acquisition | MAU | {{TARGET}} | {{TIMELINE}} |
| Revenue | MRR | {{TARGET}} | {{TIMELINE}} |
| Retention | DAU/MAU | {{TARGET}} | {{TIMELINE}} |
...
|--------|---------|--------|----------|
| DAU | 0 | {{TARGET}} | {{TIMELINE}} |
| MAU | 0 | {{TARGET}} | {{TIMELINE}} |
| Session Duration | 0 | {{TARGET}} | {{TIMELINE}} |
| Pages per Session | 0 | {{TARGET}} | {{TIMELINE}} |
